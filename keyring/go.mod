module github.com/qredo/fusionchain/keyring
...
replace (
	...
	github.com/qredo/fusionchain => ../blockchain
	github.com/qredo/fusionchain/go-client => ../go-client
...
require (
	...
	github.com/CosmWasm/wasmd v0.42.0 // indirect
